...
1. In the toolbar of the Cloud Shell pane, click the **Upload/Download files** icon, in the drop-down menu, click **Upload** and upload the files **\\\Templates\\D2.01\\d2.01-vms-template.json**, **\\Templates\\D2.01\\d2.01-vm-template.json**, and **\\Templates\\D2.01\\d2.01-vm-parameters.json** into the Cloud Shell home directory.
...
1. In the list of virtual networks, click **d2.01-vnet01**.

1. On the **d2.01-vnet01** virtual network blade, in the **Settings** section, click **Peerings** and then click **+ Add**.
...
1. On the **Virtual machines** blade, in the list of virtual machines, click **d2.01-vm0**.

1. On the **d2.01-vm0** virtual machine blade, in the **Settings** section, click **Networking**.

1. Click the **d2.01-nic0** link next to the **Network interface** label, and then, on the **d2.01-nic0** network interface blade, in the **Settings** section, in the **Settings** section, click **IP configurations**. 
...
1. In the Azure portal, navigate back to the **d2.01-vm0** Azure virtual machine blade and click **Overview**.

1. On the **d2.01-vm0** blade, in the **Operations** section, click **Run command**, and, in the list of commands, click **RunPowerShellScript**.
...
1. Back on the **Route tables** blade, click **Refresh** and then click **d2.01-rt23**.

1. On the **d2.01-rt23** route table blade, click **Routes** and then click **+ Add**.
...
1. Back on the **d2.01-rt23** route table blade, click **Subnets** and then click **+ Associate**.

1. Associate the route table **d2.01-rt23** with the following subnet:
...
1. Back on the **Route tables** blade, click **Refresh** and then click **d2.01-rt32**.

1. On the **d2.01-rt32** route table blade, click **Routes** and then click **+ Add**.
...
1. Back on the **d2.01-rt32** route table blade, click **Subnets** and then click **+ Associate**.

1. Associate the route table **d2.01-rt32** with the following subnet:
...
1. Click **Check** and wait until results of the connectivity check are returned. Verify that the status is **Reachable**. Review the network path and note that the traffic was routed via **10.60.0.4**, assigned to the **d2.01-nic0** network adapter. If status is **Unreachable**, you should restart d2.01-vm0.
...
1. On the **d2.01-lb4** load balancer blade, click **Backend pools** and click **+ Add**.
...
1. Verify that the browser window displays the message **Hello World from d2.01-vm0** or **Hello World from d2.01-vm1**.
...
1. On the **Virtual networks** blade, in the list of virtual networks, click **d2.01-vnet01**.

1. On the  **d2.01-vnet01** virtual network blade, in the **Settings** section, click **Subnets**, and then click **+ Subnet**.
...
1. In the Azure portal, search and select **Application Gateways** and, on the **Application Gateways** blade, click **d2.01-appgw5**.

1. On the **d2.01-appgw5** Application Gateway blade, note the value of the **Frontend public IP address**.

1. Start another browser window and navigate to the IP address you identified in the previous step.

1. Verify that the browser window displays the message **Hello World from d2.01-vm2** or **Hello World from d2.01-vm3**.
