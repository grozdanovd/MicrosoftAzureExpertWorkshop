...
1. In the toolbar of the Cloud Shell pane, click the **Upload/Download files** icon, in the drop-down menu, click **Upload** and upload the files **\\\Templates\\d2.01-vms-template.json**, **\\Templates\\d2.01-vm-template.json**, and **\\Templates\\d2.01-vm-parameters.json** into the Cloud Shell home directory.
