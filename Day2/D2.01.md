...
4. In the toolbar of the Cloud Shell pane, click the **Upload/Download files** icon, in the drop-down menu, click **Upload** and upload the files (previosely saved on the **Desktop**) **d2.01-vms-template.json**, **d2.01-vm-template.json**, and **d2.01-vm-parameters.json** into the Cloud Shell home directory.
