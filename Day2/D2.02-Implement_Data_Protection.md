...
1. Within the Remote Desktop session to **d2-02-vm1**, open File Explorer, navigate to the **C:\\Windows\\System32\\drivers\\etc\\** folder and delete the **hosts** file.

1. Switch to the Microsoft Azure Backup window and click **Recover data**. This will start **Recover Data Wizard**.

1. On the **Getting Started** page of **Recover Data Wizard**, ensue that **This server (d2-02-vm1.)** option is selected and click **Next**.
...
1. In the Azure portal, search for and select **Virtual machines**, and on the **Virtual machines** blade, click **d2-02-vm0**.

1. On the **d2-02-vm0** blade, click **Connect**, in the drop-down menu, click **RDP**, on the **Connect with RDP** blade, click **Download RDP File** and follow the prompts to start the Remote Desktop session.
...
1. Within the Remote Desktop session to the **d2-02-vm0** Azure virtual machine, in the **Server Manager** window, click **Local Server**, click **IE Enhanced Security Configuration** and turn it **Off** for Administrators.

1. Within the Remote Desktop session to the **d2-02-vm0**, click **Start**, expand the **Windows System** folder, and click **Command Prompt**.
...
1. Within the Remote Desktop session to the **d2-02-vm0** Azure virtual machine, start Internet Explorer, browse to the [Azure portal](https://portal.azure.com), and sign in using your credentials. 

1. In the Azure portal, search for and select **Recovery Services vaults** and, on the **Recovery Services vaults**, click **d2-02-rsv1**.

1. On the **d2-02-rsv1** Recovery Services vault blade, in the **Protected items** section, click **Backup items**.

1. On the **d2-02-rsv1 - Backup items** blade, click **Azure Virtual Machine**. 

1. On the **Backup Items (Azure Virtual Machine)** blade, click **d2-02-vm0**.

1. On the **d2-02-vm0** Backup Item blade, click **File Recovery**.
...
1. On the lab computer, in the Azure portal, search for and select **Recovery Services vaults** and, on the **Recovery Services vaults**, click **d2-02-rsv1**.

1. On the **d2-02-rsv1** Recovery Services vault blade, in the **Protected items** section, click **Backup items**.

1. On the **d2-02-rsv1 - Backup items** blade, click **Azure Backup Agent**.

1. On the **Backup Items (Azure Backup Agent)** blade, click the entry representing the backup of **d2-02-vm1**.

1. On the **C:\\ on d2-02-vm1.** blade, click the **d2-02-vm1.** link.

1. On the **d2-02-vm1.** Protected Servers blade, click **Delete**.

1. On the **Delete** blade, specify the following settings.

    | Settings | Value |
    | --- | --- |
    | TYPE THE SERVER NAME | **d2-02-vm1.** |
...
1. Navigate back to the **d2-02-rsv1 - Backup items** blade and click **Azure Virtual Machines**.

1. On the **d2-02-rsv1 - Backup items** blade, click **Azure Virtual Machine**. 

1. On the **Backup Items (Azure Virtual Machine)** blade, click **d2-02-vm0**.

1. On the **d2-02-vm0** Backup Item blade, click **Stop backup**. 

1. On the **Stop backup** blade, select **Delete Backup Data**, specify the following settings and click **Stop backup**:

    | Settings | Value |
    | --- | --- |
    | Type the name of Backup item | **d2-02-vm0** |
    | Reason | **Others** |
    | Comments | **az104 10 lab** |

1. Navigate back to the **d2-02-rsv1 - Backup items** blade and click **Refresh**.

    >**Note**: The **Azure Virtual Machine** entry is still lists **1** backup item.

1. Click the **Azure Virtual Machine** entry and, on the **Backup Items (Azure Virtual Machine)** blade, click the **d2-02-vm0** entry.

1. On the **d2-02-vm0** Backup Item blade, note that you have the option to **Undelete** the deleted backup. 
...
1. Navigate back to the **d2-02-rsv1** Recovery Services vault blade, and in the **Settings** section, click **Properties**.

1. On the **d2-02-rsv1 - Properties** blade, click the **Update** link under **Security Settings** label. 
...
1. Navigate back to the **d2-02-vm0** Backup Item blade and click **Undelete**. 

1. On the **Undelete d2-02-vm0** blade, click **Undelete**. 

1. Wait for the undelete operation to complete, refresh the browser page, if needed, navigate back to the **d2-02-vm0** Backup Item blade, and click **Delete backup data**.
