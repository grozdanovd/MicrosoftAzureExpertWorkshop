...
3. On the **Basics** tab, fill in the following information (leave the defaults for everything else):
    ...
    | Virtual machine name | **SomeWinVMname** |
...
10. On the **SomeWinVMname** virtual machine blade, click **Networking**, review the **Inbound port rules** tab, and note that there is no network security group associated with the network interface of the virtual machine or the subnet to which the network interface is attached.
...
1. In the Azure portal, navigate to the blade of the **SomeWinVMname** virtual machine. 
...
2. After the machine starts, open an **Internet Explorer** / **Microsoft Edge** browser. 

3. Verify that you can access **https://www.bing.com** and then close browser. You will need to work through the IE enhanced security pop-ups. 

    **Note**: We will now configure a rule to deny outbound internet access. 

4. In the Azure portal, navigate back to the blade of the **SomeWinVMname** virtual machine. 
